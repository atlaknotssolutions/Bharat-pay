...
// //                           {user.channels.map((c) => c.name).join(", ")}
// //                         </p>
// //                       )}
// //                     </td>
...
// //               <button onClick={() => setDetailModal(false)} className="p-1 hover:bg-gray-100 rounded-lg">
// //                 <X size={20} />
// //               </button>
// //             </div>
...
// //                   {selectedUser.avatar ? (
// //                     <img src={selectedUser.avatar} className="w-16 h-16 rounded-full object-cover" />
// //                   ) : (
...
// //                   <span className={`mt-1 inline-block px-2.5 py-0.5 text-xs font-semibold rounded-full capitalize ${roleColor(selectedUser.role)}`}>
// //                     {selectedUser.role}
// //                   </span>
// //                 </div>
// //               </div>
...
// //                   <p className="text-2xl font-bold text-amber-700">{selectedUser.totalChannels}</p>
// //                   <p className="text-xs text-amber-600">Channels</p>
// //                 </div>
// //                 <div className="bg-blue-50 p-3 rounded-xl text-center">
// //                   <p className="text-2xl font-bold text-blue-700">{selectedUser.totalVideos}</p>
// //                   <p className="text-xs text-blue-600">Videos</p>
// //                 </div>
// //                 <div className="bg-green-50 p-3 rounded-xl text-center">
// //                   <p className="text-2xl font-bold text-green-700">{selectedUser.trustScore}</p>
// //                   <p className="text-xs text-green-600">Trust Score</p>
// //                 </div>
// //                 <div className="bg-purple-50 p-3 rounded-xl text-center">
// //                   <p className="text-2xl font-bold text-purple-700">{selectedUser.rewardPoints}</p>
...
// //                       <div key={ch._id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
// //                         <div className="w-10 h-10 rounded-lg bg-amber-100 flex items-center justify-center">
// //                           {ch.channelImage ? (
// //                             <img src={ch.channelImage} className="w-10 h-10 rounded-lg object-cover" />
// //                           ) : (
...
// //                           <p className="text-xs text-gray-500">{ch.totalVideos} videos</p>
// //                         </div>
// //                       </div>
// //                     ))}
// //                   </div>
...
// //               <button onClick={() => setEditModal(false)} className="p-1 hover:bg-gray-100 rounded-lg">
// //                 <X size={20} />
// //               </button>
// //             </div>
...
//   // Detail modal se Edit open karne ke liye
...
//               {/* Update Button inside Detail Modal */}
