function getPasswordChangeConfirmationMailOptions(email, name) {
  return {
...
<body>
  <div class="container">
    ...
    <div class="footer">
      &copy; 2025 BharatPlay. All rights reserved.
    </div>
  </div>
</body>
</html>`,
...
module.exports = getPasswordChangeConfirmationMailOptions;
